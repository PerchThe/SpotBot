...
public class ConsiderCommand extends SlashCommand {

    private static final FlatFileSection commands = Configuration.getCommands().getSection("consider-command");
    ...
    public void onExecute(SlashExecutor cmd) {
        ...
        suggestion.consider();
        SpotMessage spotMessage = new SpotMessage(Configuration.getLang().getSection("lang.suggestion-considering"), cmd);
