...
public class NoteCommand extends SlashCommand {
    ...
    private static final FlatFileSection commands = Configuration.getCommands().getSection("note-command");
    ...
    public void onExecute(SlashExecutor cmd) {
        ...
        suggestion.setNote(cmd.getOption("note").getAsString(), cmd.getMember());
        SpotMessage spotMessage = new SpotMessage(Configuration.getLang().getSection("lang.suggestion-note"), cmd);
